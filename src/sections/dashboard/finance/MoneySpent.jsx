...
function SpentCard({ name, img, percentage, money }) {
...
SpentCard.propTypes = { name: PropTypes.string, img: PropTypes.string, percentage: PropTypes.number, money: PropTypes.number };
